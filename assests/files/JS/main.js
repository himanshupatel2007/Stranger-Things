...
goThroughAnimation.addEventListener("click", () => {
  playIntoMusic();
  fadeWelcomeScreen();
  loadStrangerThingsAnimation();
  const Home = document.querySelector("#loadHome");
  ...
  gsap.fromTo(
    ...
    },
    {
      onStart: () => {
        gsap.set(".background", {
          backgroundImage:
            'url("./assests/images/seasons/seasonsBackground.webp")',
        });
      },
      delay: 0.5,
      opacity: 1,
...
document.querySelectorAll(".watchNetflix").forEach((e) => {
...
document
  .querySelector(".trailerContainer")
  .addEventListener("click", (e) => redirectYoutube(e));
